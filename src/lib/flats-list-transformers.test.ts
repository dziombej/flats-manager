...
import { transformFlatsListData, transformFlatToCardViewModel } from "./flats-list-transformers";
...
describe("transformFlatToCardViewModel", () => {
  ...
  it("should handle long addresses", () => {
    ...
    // Assert
    expect(result.address).toBe(
      "Very Long Street Name 123, Apartment 45, Building C, District X, 00-123 Warsaw, Poland"
    );
  });
