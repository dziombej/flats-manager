...
describe('DashboardStats Component', () => {
  ...
  describe('Total Flats Calculation', () => {
    ...
    it('should show correct count for multiple flats', () => {
      const flats: DashboardFlatDto[] = [
        { id: '1', name: 'Flat 1', address: 'Address 1', debt: 100, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
        { id: '2', name: 'Flat 2', address: 'Address 2', debt: 200, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
        { id: '3', name: 'Flat 3', address: 'Address 3', debt: 0, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
      ];
      render(<DashboardStats flats={flats} />);
  ...
  describe('Total Debt Calculation', () => {
    it('should show 0,00\s*zł when no flats', () => {
      const flats: DashboardFlatDto[] = [];
      render(<DashboardStats flats={flats} />);
    ...
    it('should show 0,00\s*zł when all flats have zero debt', () => {
      const flats: DashboardFlatDto[] = [
        { id: '1', name: 'Flat 1', address: 'Address 1', debt: 0, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
        { id: '2', name: 'Flat 2', address: 'Address 2', debt: 0, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
      ];
      render(<DashboardStats flats={flats} />);
    ...
    it('should calculate total debt correctly for single flat', () => {
      const flats: DashboardFlatDto[] = [
        { id: '1', name: 'Flat 1', address: 'Address 1', debt: 1234.56, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
      ];
      render(<DashboardStats flats={flats} />);
    ...
    it('should calculate total debt correctly for multiple flats', () => {
      const flats: DashboardFlatDto[] = [
        { id: '1', name: 'Flat 1', address: 'Address 1', debt: 100, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
        { id: '2', name: 'Flat 2', address: 'Address 2', debt: 200, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
        { id: '3', name: 'Flat 3', address: 'Address 3', debt: 300.50, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
      ];
      render(<DashboardStats flats={flats} />);
    ...
    it('should handle very large total debt', () => {
      const flats: DashboardFlatDto[] = [
        { id: '1', name: 'Flat 1', address: 'Address 1', debt: 999999.99, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
      ];
      render(<DashboardStats flats={flats} />);
    ...
    it('should handle mixed debt and paid flats', () => {
      const flats: DashboardFlatDto[] = [
        { id: '1', name: 'Flat 1', address: 'Address 1', debt: 500, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
        { id: '2', name: 'Flat 2', address: 'Address 2', debt: 0, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
        { id: '3', name: 'Flat 3', address: 'Address 3', debt: 250.75, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
      ];
      render(<DashboardStats flats={flats} />);
    ...
    it('should format decimal amounts with two decimal places', () => {
      const flats: DashboardFlatDto[] = [
        { id: '1', name: 'Flat 1', address: 'Address 1', debt: 100.5, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
      ];
      render(<DashboardStats flats={flats} />);
  ...
  describe('Flats With Debt Calculation', () => {
    ...
    it('should count flats with any positive debt', () => {
      const flats: DashboardFlatDto[] = [
        { id: '1', name: 'Flat 1', address: 'Address 1', debt: 100, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
        { id: '2', name: 'Flat 2', address: 'Address 2', debt: 0, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
        { id: '3', name: 'Flat 3', address: 'Address 3', debt: 0.01, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
      ];
      render(<DashboardStats flats={flats} />);
    ...
    it('should handle edge case of very small debt (0.01)', () => {
      const flats: DashboardFlatDto[] = [
        { id: '1', name: 'Flat 1', address: 'Address 1', debt: 0.01, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
      ];
      render(<DashboardStats flats={flats} />);
  ...
  describe('Flats Paid Up Calculation', () => {
    it('should count flats with zero debt', () => {
      const flats: DashboardFlatDto[] = [
        { id: '1', name: 'Flat 1', address: 'Address 1', debt: 0, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
        { id: '2', name: 'Flat 2', address: 'Address 2', debt: 100, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
        { id: '3', name: 'Flat 3', address: 'Address 3', debt: 0, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
      ];
      render(<DashboardStats flats={flats} />);
    ...
    it('should not count flats with small debt as paid up', () => {
      const flats: DashboardFlatDto[] = [
        { id: '1', name: 'Flat 1', address: 'Address 1', debt: 0, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
        { id: '2', name: 'Flat 2', address: 'Address 2', debt: 0.01, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
      ];
      render(<DashboardStats flats={flats} />);
  ...
  describe('Edge Cases', () => {
    ...
    it('should verify with debt + paid up = total flats', () => {
      const flats: DashboardFlatDto[] = [
        { id: '1', name: 'Flat 1', address: 'Address 1', debt: 100, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
        { id: '2', name: 'Flat 2', address: 'Address 2', debt: 0, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
        { id: '3', name: 'Flat 3', address: 'Address 3', debt: 200, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
        { id: '4', name: 'Flat 4', address: 'Address 4', debt: 0, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
      ];
      render(<DashboardStats flats={flats} />);
    ...
    it('should handle floating point precision issues', () => {
      const flats: DashboardFlatDto[] = [
        { id: '1', name: 'Flat 1', address: 'Address 1', debt: 0.1, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
        { id: '2', name: 'Flat 2', address: 'Address 2', debt: 0.2, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
      ];
      render(<DashboardStats flats={flats} />);
  ...
  describe('Polish Currency Format', () => {
    it('should use Polish locale with PLN currency', () => {
      const flats: DashboardFlatDto[] = [
        { id: '1', name: 'Flat 1', address: 'Address 1', debt: 1000, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
      ];
      render(<DashboardStats flats={flats} />);
    ...
    it('should always show two decimal places', () => {
      const flats: DashboardFlatDto[] = [
        { id: '1', name: 'Flat 1', address: 'Address 1', debt: 5, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
      ];
      render(<DashboardStats flats={flats} />);
