...
- **Astro API Endpoint** - endpointy backendu (/api/auth/*, /api/flats/*, etc.)
...
5. Layout pobiera user z getUser() i przekazuje do window.__AUTH_USER__
...
4. `/src/env.d.ts` - Typy dla window.__AUTH_USER__
